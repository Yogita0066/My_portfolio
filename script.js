!function() {
            ...
            class o {
                ...
                trigger(t, e) {
                    ...
                    try {
                        ...
                        if (n.initEvent(`${this.eventPrefix}${t}`, !0, !0),
                        n.data = e,
                ...
                _flushAllFromQueue() {
                    for (; 0 !== this.queue.length; ) {
                        const {method: t, args: e} = this.queue.shift();
                        this[t].apply(null, e)
                    }
                }
                open() {
    ...
    function() {
        const t = Date.now()
          ...
          , i = function() {
            ...
            return function(d, a) {
                ...
                "complete" === document.readyState || !document.attachEvent && "interactive" === document.readyState ? setTimeout(o, 1) : n || (document.addEventListener ? (document.addEventListener("DOMContentLoaded", o, !1),
                window.addEventListener("load", o, !1)) : (document.attachEvent("onreadystatechange", i),
        ...
        function d(t) {
            ...
            }(t, `${o.replace(/\/$/, "")}/1_186_0/static/js/widget.${n.h()}.js`)
        }
        const a = n(2655).Z;
        window.tidioChatApi = new a,
        i((()=>setTimeout((()=>{
            var i = window.document.getElementById("tidio-chat-code")
              , a = window.Shopify && !0 === window.Shopify.designMode
            ...
            !function(t, e, n) {
                ...
                e && window.__REDUX_DEVTOOLS_EXTENSION__ && (i.contentWindow.__REDUX_DEVTOOLS_EXTENSION__ = window.__REDUX_DEVTOOLS_EXTENSION__,
                i.contentWindow.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__),
                function(t) {
                    let e = "//localhost:3000/static/js/WidgetIframe.js";
                    e = `${o}1_186_0/static/js/chunk-WidgetIframe-${n.h()}.js`;
                ...
                function(t) {
                    ...
                    e.rel = "preload",
                    e.href = "https://widget-v4.tidiochat.com/fonts/mulish_SGhgqk3wotYKNnBQ.woff2",
                    e.as = "font",
                    e.type = "font/woff2",
                    e.crossOrigin = "",
                ...
                i.contentWindow.FIRST_POSSIBLE_JS_EXECUTION = t,
